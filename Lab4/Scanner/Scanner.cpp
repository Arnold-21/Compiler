...
bool Scanner::treatIntConstant(){
    ...
    //Check if we find an integer with a finite automata
    FiniteAutomata automata("FiniteAutomata/integer.in");
...
bool Scanner::treatIdentifier(){
    ...
    //Check if we find an identifier with a finite automata
