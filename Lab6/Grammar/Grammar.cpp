...
std::vector<std::string> Grammar::getProduction(std::string symbol, int index){
    std::vector<std::string> returnVector;

    std::vector<std::vector<std::string>> productionVectors = this->productions.at(std::vector<std::string>{symbol});
    if (productionVectors.size() > index) returnVector = productionVectors.at(index);
